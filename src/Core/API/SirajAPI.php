...
/**
 * SirajAPI (سراج) - API Management and Knowledge Discovery System
 *
 * Siraj means "Light" or "Lamp" in Arabic. This class provides
...
class SirajAPI
{
    ...
    protected function initializeAPI(): self
    {
        ...
        $this->logger->info('SirajAPI system initialized');
