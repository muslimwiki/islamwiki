...
use IslamWiki\Core\Logging\ShahidLoggingService;

/**
 * Shahid Error Handler Middleware
 * 
 ...
 * @license AGPL-3.0
 */
class ShahidErrorHandlerMiddleware
{
    private ShahidLoggingService $logger;
    private array $config;

    public function __construct(ShahidLoggingService $logger, array $config = [])
    {
        $this->logger = $logger;
