...
/**
 * Routing Caching Service (رحلة - Journey)
 * 
...
class RoutingCachingService
{
     ...
     */
    private function createStore(array $config): RoutingStoreInterface
    {
        return match ($config['driver']) {
            'file' => new RoutingFileStore($config),
            'database' => new RoutingDatabaseStore($config),
            'memory' => new RoutingMemoryStore($config),
     ...
     * Get cache store
     */
    private function getStore(): RoutingStoreInterface
    {
 ...
 * File Cache Store
 */
class RoutingFileStore implements RoutingStoreInterface
{
    private string $path;
 ...
 * Memory Cache Store
 */
class RoutingMemoryStore implements RoutingStoreInterface
{
    private array $data = [];
 ...
 */
class RoutingDatabaseStore implements RoutingStoreInterface
{
