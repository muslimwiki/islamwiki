 ...
 *
 * Asas means "Foundation" in Arabic. This class provides the bootstrap
...
class AsasBootstrap
{
     ...
     */
    protected AsasFoundation $foundation;
    ...
    {
        $this->container = new AsasContainer();
     ...
     * @return self
     */
    protected function initializeFoundation(): self
    {
        $this->foundation = new AsasFoundation($this->container, $this->basePath);
        $this->foundation->initialize();
        $this->logger->info('Foundation system initialized');
...
<body>
     ...
     *
     * @return AsasFoundation
     */
    public function getFoundation(): AsasFoundation
    {
