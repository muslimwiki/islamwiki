...
try {
        ...
        if (password_verify($password, $user['password'])) {
            ...
            try {
                ...
                if ($auth->attempt($username, $password)) {
                    ...
                    $temp_df15ddc0 = ($session->isAdmin() ? 'Yes' : 'No') . "\n";
                    echo "- Is Admin: " . $temp_df15ddc0;
                    ...
                    echo "- Is logged in: " . $temp_943497ca;
                    $temp_df15ddc0 = ($session->isAdmin() ? 'Yes' : 'No') . "\n";
                    echo "- Is admin: " . $temp_df15ddc0;
                    ...
                    echo "- Logout: Success\n";
                    $temp_943497ca = ($session->isLoggedIn() ? 'Yes' : 'No') . "\n";
                    echo "- Is logged in after logout: " . $temp_943497ca;
                } else {
    ...
    foreach ($routes as $route) {
        if (strpos($route['route'], '/login') !== false) {
            ...
            $temp_c87c0701 = $route['route'] . " -> " . $route['handler'] . "\n";
            echo "- Login route found: " . $temp_c87c0701;
        }
    }
