...
try {
    ...
    echo "<ul>\n";
        $temp_c256a542 = (class_exists($container->get('app')::class) ? '✅' : '❌') . "</li>\n";
        echo "<li>app: " . $temp_c256a542;
        $temp_11e781e6 = (class_exists($container->get('db')::class) ? '✅' : '❌') . "</li>\n";
        echo "<li>db: " . $temp_11e781e6;
        $temp_deeb0307 = (class_exists($container->get(\Psr\Log\LoggerInterface::class)::class) ? '✅' : '❌') . "</li>\n";
        echo "<li>logger: " . $temp_deeb0307;
    echo "</ul>\n";
    ...
    try {
        ...
        $temp_66179261 = htmlspecialchars($e->getMessage()) . "</p>\n";
        echo "<p>❌ Error creating BayanManager: " . $temp_66179261;
    }
    ...
    try {
        ...
        $temp_66179261 = htmlspecialchars($e->getMessage()) . "</p>\n";
        echo "<p>❌ 'bayan' binding not found: " . $temp_66179261;
    }
} catch (\Exception $e) {
    echo "<h1>❌ Error in Debug</h1>\n";
        $temp_66179261 = htmlspecialchars($e->getMessage()) . "</p>\n";
        echo "<p><strong>Error:</strong> " . $temp_66179261;
