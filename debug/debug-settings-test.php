    ...
    foreach ($availableSkinNames as $skinName) {
        ...
        if ($hasSkin) {
            ...
            if ($result) {
                ...
                $temp_5fce43ab = ($activeSkin ? $activeSkin->getName() : 'None') . "\n";
                echo "  - Active skin: " . $temp_5fce43ab;
                $temp_913b40c5 = $skinManager->getActiveSkinName() . "\n";
                echo "  - Active skin name: " . $temp_913b40c5;
            }
        }
    }
        ...
        foreach ($skinDirs as $skinDir) {
            ...
            if (file_exists($skinConfigFile)) {
                try {
                    ...
                    echo "  - Error loading skin {$skinName}: " . $temp_c9c6f9b2;
                }
            }
        }
    }

        $temp_3a3e8386 = count($availableSkinsFromDir) . "\n";
        echo "- Discovered skins from directory: " . $temp_3a3e8386;
    ...
    foreach ($availableSkinsFromDir as $key => $skinData) {
        ...
        if ($skinExists) {
            ...
            if ($result) {
                $activeSkin = $skinManager->getActiveSkin();
                $temp_5fce43ab = ($activeSkin ? $activeSkin->getName() : 'None') . "\n";
                echo "  - New active skin: " . $temp_5fce43ab;
            }
        }
    }
