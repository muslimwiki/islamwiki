...
try {
    ...
    try {
        ...
        $temp_cb671bc9 = ($appInstance ? get_class($appInstance) : 'None') . "\n";
        echo "- App Instance: " . $temp_cb671bc9;
        ...
        if ($appInstance) {
            ...
            if ($container) {
                ...
                foreach ($services as $service => $available) {
                    $temp_63c9b120 = ($available ? 'Available' : 'Not available') . "\n";
                    echo "  - {$service}: " . $temp_63c9b120;
                }
            }
        }
    } catch (Exception $e) {
