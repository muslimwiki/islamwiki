...
try {
    ...
    echo "- Initial Middleware Stack: " . ($middlewareStack ? get_class($middlewareStack) : 'None') . "\n";
    ...
    $middlewareStack = $middlewareStackProperty->getValue($router);
    echo "- Final Middleware Stack: " . ($middlewareStack ? get_class($middlewareStack) : 'None') . "\n";
