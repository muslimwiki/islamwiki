...
<head>
    ...
    <title>ZamZam Simple Method Test</title>
    <style>
...
<body>
    <h1>🕌 ZamZam Simple Method Test</h1>
    ...
    <script>
        ...
        log('=== ZAMZAM SIMPLE METHOD TEST START ===');
                ...
                if (window.ZamZamInstance) {
                    ...
                    if (component) {
                        ...
                        if (component.data.showMessage) {
                            ...
                            try {
                                log('Testing method call...');
                                component.data.showMessage('Direct test');
                                log('Method called successfully');
                                log('Updated data: ' + JSON.stringify(component.data));
                            } catch (e) {
                                error('Error calling method: ' + e.message);
                            }
                        } else {
