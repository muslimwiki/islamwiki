...
<body>
    ...
    <div class="test">
        ...
        <div z-data='{"test": false}'>
            ...
            <div z-show="test" class="alert alert-success" id="test-content">This should show/hide</div>
        </div>
    </div>
        ...
        script.onload = function() {
            ...
            setTimeout(() => {
                if (window.ZamZamInstance) {
                    ...
                    // Test the DOM directly
                    const testContent = document.getElementById('test-content');
                    log('Initial display style: ' + testContent.style.display);
                    ...
                    if (component) {
                        ...
                        // Check DOM after applying directives
                        log('Display style after applying directives: ' + testContent.style.display);
                        
                        // Manually set display to test
                        testContent.style.display = 'block';
                        log('Manually set display to block');
                        log('Display style after manual set: ' + testContent.style.display);
                    }
                } else {
