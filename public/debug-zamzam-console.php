...
<head>
    ...
    <title>ZamZam Console Debug</title>
    <style>
...
<body>
    <h1>🕌 ZamZam Console Debug</h1>
    
    <div class="debug">
        <h3>Console Output:</h3>
        <div id="console-output">Check browser console for debug info...</div>
    </div>
    ...
    <script>
        ...
        console.log = function(...args) {
            ...
            outputDiv.innerHTML += '<div style="color: blue;">LOG: ' + args.join(' ') + '</div>';
        };
        
        console.error = function(...args) {
            originalError.apply(console, args);
            outputDiv.innerHTML += '<div style="color: red;">ERROR: ' + args.join(' ') + '</div>';
        };
        
        console.log('=== ZAMZAM CONSOLE DEBUG START ===');
