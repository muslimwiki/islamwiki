...
<head>
    ...
    <title>ZamZam Button Test</title>
    <style>
        body {
    ...
    <div class="test-box">
        ...
        <div z-data='{"show": false}'>
            ...
            <div z-show="show" class="alert alert-success">
                ✅ This content should show/hide when you click the button!
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        setTimeout(() => {
            ...
            if (window.ZamZamInstance) {
                statusDiv.innerHTML = '<div class="status success">✅ ZamZam is loaded! Try clicking the buttons above.</div>';
                console.log('✅ ZamZam is loaded!');
            } else {
