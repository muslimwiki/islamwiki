...
try {
    ...
    if ($skinManager->hasSkin('Muslim')) {
        ...
        if ($success) {
            ...
            $temp_b9816842 = $skinManager->getActiveSkinName() . "</strong></p>";
            echo "<p>New active skin: <strong>" . $temp_b9816842;
    ...
    $invalidResult = $skinManager->setActiveSkin('NonExistentSkin');
        $temp_ceba36fe = ($invalidResult ? 'true' : 'false') . "</p>";
        echo "<p>Setting invalid skin result: " . $temp_ceba36fe;
    ...
    global $wgActiveSkin, $wgValidSkins;
        ...
        $temp_5e3c67da = ($wgActiveSkin ?? 'not set') . "</strong></p>";
        echo "<p>wgActiveSkin from LocalSettings: <strong>" . $temp_5e3c67da;
    ...
    foreach ($testSkins as $skinName) {
        ...
        $status = $hasSkin ? "✅" : "❌";
        $temp_bf7b1460 = ($hasSkin ? 'Available' : 'Not available') . "</li>";
        echo "<li>$status $skinName: " . $temp_bf7b1460;
    }
    echo "</ul>";
    ...
    $duration = ($endTime - $startTime) * 1000;
        ...
        $temp_50206c7d = number_format($duration, 2) . "ms</strong></p>";
        echo "<p>100 getActiveSkinName() calls took: <strong>" . $temp_50206c7d;
    ...
    $duration = ($endTime - $startTime) * 1000;
        ...
        $temp_50206c7d = number_format($duration, 2) . "ms</strong></p>";
        echo "<p>100 static getActiveSkinNameStatic() calls took: <strong>" . $temp_50206c7d;
