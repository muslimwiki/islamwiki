...
try {
    ...
    if (file_exists($localSettingsPath)) {
        ...
        echo "wgValidSkins: " . (isset($wgValidSkins) ? implode(', ', array_keys($wgValidSkins)) : 'Not set') . "<br>\n";
    ...
    if ($activeSkin) {
        echo "✅ Active skin: " . $activeSkin->getName() . " (v" . $activeSkin->getVersion() . ")<br>\n";
    } else {
    ...
    if (is_dir($skinsPath)) {
        ...
        echo "Skin directories found: " . implode(', ', array_map('basename', $skinDirs)) . "<br>\n";
        ...
        foreach ($skinDirs as $skinDir) {
            ...
            echo "  - Config: " . (file_exists($configFile) ? '✅' : '❌') . " $configFile<br>\n";
            echo "  - CSS: " . (file_exists($cssFile) ? '✅' : '❌') . " $cssFile<br>\n";
            echo "  - JS: " . (file_exists($jsFile) ? '✅' : '❌') . " $jsFile<br>\n";
            echo "  - Layout: " . (file_exists($layoutFile) ? '✅' : '❌') . " $layoutFile<br>\n";
        }
    } else {
