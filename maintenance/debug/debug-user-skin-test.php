...
try {
    ...
    echo "- Updated User Skin Object: " . ($updatedUserSkinObject ? $updatedUserSkinObject->getName() : 'None') . "\n";
    ...
    echo "- Final User Skin Object: " . ($finalUserSkinObject ? $finalUserSkinObject->getName() : 'None') . "\n";
