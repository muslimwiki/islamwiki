...
try {
    ...
    echo "\n📋 Skin availability:\n";
    echo "- Muslim skin exists: " . ($skinManager->hasSkin('Muslim') ? 'Yes' : 'No') . "\n";
    echo "- Bismillah skin exists: " . ($skinManager->hasSkin('Bismillah') ? 'Yes' : 'No') . "\n";
    ...
    echo "🎯 Active skin object: " . ($activeSkin ? $activeSkin->getName() : 'null') . "\n";
