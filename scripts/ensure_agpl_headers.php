        ...
        if ($file->isFile() && $file->getExtension() === 'php') {
            ...
            if (strpos($content, 'GNU Affero General Public License') !== false && 
                ...
                if ($secondPhpTagPos !== false && $secondPhpTagPos < 100) {
                    // Fix duplicate PHP tag
                    $content = '<?php' . substr($content, $secondPhpTagPos + 5);
                    file_put_contents($filePath, $content);
                    echo "Fixed duplicate PHP tag in: $filePath\n";
                    $filesUpdated++;
                }
                continue;
            }
            ...
            if ($newContent !== $content) {
                ...
                echo "Added/Updated license header in: $filePath\n";
                $filesUpdated++;
            }
        }
    }
